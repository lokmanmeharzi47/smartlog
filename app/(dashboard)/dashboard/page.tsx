      ...
      <main className="flex-1 p-6 space-y-6 fade-in">
        ...
        <div className="grid grid-cols-4 gap-4">
          <KpiCard
            ...
            delta={`${stats?.totalProducts ?? 0} références`}
            deltaPositive
            icon={<Package />}
            accentColor="cyan"
            loading={loading}
          ...
          <KpiCard
            ...
            delta={stats?.criticalItems ? `⚠ ${stats.criticalItems} à commander` : '✓ Stock OK'}
            deltaPositive={(stats?.criticalItems ?? 0) === 0}
            icon={<AlertTriangle />}
            accentColor="red"
            loading={loading}
          />
          ...
          <KpiCard
            ...
            delta={`Valeur: ${fmt(stats?.totalValue ?? 0)} DZD`}
            deltaPositive={(stats?.coverageRate ?? 0) >= 80}
            icon={<TrendingUp />}
            accentColor="orange"
            loading={loading}
          />
